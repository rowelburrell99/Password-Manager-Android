...
public class VibrantMain extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vibrantmain);
    ...
    public void OpenReg(View view) {
        startActivity(new Intent(this, VibrantRegister.class));
    }

    public void OpenReset(View view) {
        startActivity(new Intent(this, VibrantReset.class));
    }

    public void OpenHint(View view) {
        startActivity(new Intent(this, VibrantHint.class));
    }
